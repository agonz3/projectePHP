...
<div class="main-content">
  ...
  <div class="action-panel">
    ...
    <div class="action-card">
      <h3>Usuarios</h3>
      <p>Gestiona las cuentas de usuario con acceso al sistema.</p>
      <a href="agregar_usuario.php" class="action-btn" style="margin-right: 10px;">Agregar Usuario</a>
      <a href="listar_usuarios.php" class="action-btn">Listar / Editar Usuarios</a>
    </div>
  </div>
